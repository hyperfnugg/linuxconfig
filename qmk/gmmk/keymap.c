...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [QWERTY] = LAYOUT(
        ...
        LT(EXTRAS, KC_ESC), KC_A,KC_S,KC_D, KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           M_HOME,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   M_END,
    ...
    [EXTRAS] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,M_OE   , M_AE   ,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, M_HOME , M_END  , _______, _______, _______,          _______, _______, M_HOME ,
    ...
    [CONFIG] = LAYOUT(
        ...
        _______,          _______, _______, _______, _______, _______, KC_NLCK, M_OS_MAC,_______, _______, _______,          _______, RGB_SAI, RGB_TOG,
